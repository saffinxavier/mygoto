# MyGoTo — Codex and Cursor project picker prompts

Paste the matching block into a Codex or Cursor project chat when you want recommendations from your personal catalog.

**Live catalog:** https://saffinxavier.github.io/mygoto/  
**Repo:** https://github.com/saffinxavier/mygoto  

You can also select the assistant and click **Copy project prompt** on the catalog page.
...
```text
You are helping me set up THIS Codex project using my personal MyGoTo catalog.
...
3. For each pick, give: name, category, why it fits here, exact Codex how-to (from the card’s Codex / Install fields), and when to skip.
4. Prefer: skills for agent workflow, tools/ui-kits for code deps, guidelines for UI audits. Verify Codex compatibility before suggesting a skill or install command. Skip unrelated platforms.
5. End with a short install order I can run in the terminal or Codex.
...
1. Open the target project in Codex or Cursor.
2. Paste the matching prompt (or use the catalog Copy button after selecting the assistant).
